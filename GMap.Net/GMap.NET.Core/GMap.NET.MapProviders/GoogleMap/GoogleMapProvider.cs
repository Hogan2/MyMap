...
namespace GMap.NET.MapProviders
{
    ...
    public abstract class GoogleMapProviderBase : GMapProvider, IRoutingProvider, IGeocodingProvider, IDirectionsProvider
    {
        ...
        {
            MapRoute ret = null;
            List<PointLatLng> points = GetRoutePoints(MakeRouteUrl(start, end, LanguageStr, avoidHighways, walkingMode), Zoom, out string tooltip, out int numLevels, out int zoomFactor);
            if (points != null)
            {
